...
public class SortedArrayStorageSelfTest {
    ...
    public void setUp() {
        ...
        original[0] = new Resume(UUID.randomUUID().toString());
        original[1] = new Resume(UUID.randomUUID().toString());
        original[2] = new Resume(UUID.randomUUID().toString());
        original[3] = new Resume(UUID.randomUUID().toString());
        original[4] = new Resume(UUID.randomUUID().toString());
        original[5] = new Resume(UUID.randomUUID().toString());
    ...
    public void update() {
        ...
        Resume resume = new Resume(original[1].getUuid());
